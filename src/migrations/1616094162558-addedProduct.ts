...
export class addedProduct1616094162558 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "product" ("id" integer NOT NULL, "name" character varying NOT NULL, "productCode" character varying NOT NULL, "manufacturer" character varying NOT NULL, CONSTRAINT "UQ_a3aead4d2b7d774d4b7e6a6c7b2" UNIQUE ("productCode"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
